...
import com.dreampany.frame.data.enums.TaskPriority;
...
public class TaskManagerV1<T extends BaseParcel, X extends Type, K extends Task<T, X>> {

    private TaskManagerV1 parent;

    public void setParent(TaskManagerV1 parent) {
        this.parent = parent;
    }

    public TaskManagerV1 getParent() {
        return parent;
    }
    ...
    public void postTask(TaskManagerV1 parent, K task) {
        this.parent = parent;
        if (exists(task)) {
            return;
        }
