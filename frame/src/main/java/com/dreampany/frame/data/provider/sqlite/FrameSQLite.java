package com.dreampany.frame.data.provider.sqlite;
...
public class FrameSQLite extends SQLite {
    ...
    public void write(Session session) {
        ...
        String[] selectionArgs = new String[]{Long.toString(session.getHash())};
    ...
    public void write(Point point) {
        ...
        String[] selectionArgs = {Long.toString(point.getHash()), point.getType().value()};
