...
import com.dreampany.frame.data.manager.InternetManager;
...
public class NetworkReceiver extends BaseReceiver {
    ...
    public NetworkReceiver(Context context, InternetManager internetManager, NetworkCallback callback) {
