...
public class DefaultStatefulLayout extends StatefulLayout {

    private String mInitialState = State.CONTENT;
    private boolean mTransitionsEnabled = true;


    public DefaultStatefulLayout(Context context) {
        super(context);
        init(context, null);
    }


    public DefaultStatefulLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }


    public DefaultStatefulLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int offlineLayoutResource = a.getResourceId(R.styleable.SflStatefulLayout_offlineLayout, R.layout.content_default_offline);
        int emptyLayoutResource = a.getResourceId(R.styleable.SflStatefulLayout_emptyLayout, R.layout.content_default_empty);
        int progressLayoutResource = a.getResourceId(R.styleable.SflStatefulLayout_progressLayout, R.layout.content_default_progress);
